...
const BusinessFinance = () => {
  ...
  return (
    <div>
      <Head>
        <title>Rekit | REKIT Blog | Business Finance</title>
        <meta
          name="description"
        ...
        <meta
          name="description"
          content="This is the blog page for Business Finance"
        />
        ...
        <meta
          property="og:title"
          content="Blog | Business Finance | Rekit Financial Advisors Limited"
        />
