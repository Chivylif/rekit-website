...
const RealEstate = () => {
  const relatedPosts = blogPosts.filter(p=> p.slug.toLowerCase() == "realEstate".toLowerCase());
  ...
  return (
    <div>
      <Head>
        <title>Rekit | REKIT Blog | Real Estate</title>
        <meta
          name="description"
        ...
        <title>REKIT Blog | Real Estate | Rekit Financial Advisors Limited</title>
        <meta charset="UTF-8" />
        <meta
          name="description"
