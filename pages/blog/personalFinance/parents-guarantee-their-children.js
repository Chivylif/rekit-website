...
import clipOne from "../../../public/assets/children-financial-future-1.jpg"
      ...
      <div className="lg:w-4/5 px-[0.2rem] pt-5 lg:pt-5 mx-auto pb-5 border-r-3"> 
              <div className="mx-auto px-[1rem]">
                  ...
                  Action Steps:
                   ...
                   <p className="leading-[1.2rem] pb-4 font-normal font-inter text-[#212020] text-[1rem]">       
                  - Save for your child’s education using dedicated <Link href={{pathname:`/goal-based-investing`}} legacyBehavior><span className="text-[#46a2da] text-decoration-line: underline">savings plans</span></Link> offered by a financial advisor.
                  </p>  
                  ...
                  Action Steps:
                   ...
                   <p className="leading-[1.2rem] pb-4 font-normal font-inter text-[#212020] text-[1rem]">       
                   - Start teaching basic financial concepts at a young age. You can get materials <Link href={{pathname:`/blog`}} legacyBehavior><span className="text-[#46a2da] text-decoration-line: underline">here</span></Link> to also educate yourself while also imparting into your child’s life
                  </p>  
                  ...
                  Action Steps:
                   ...
                   <p className="leading-[1.2rem] pb-4 font-normal font-inter text-[#212020] text-[1rem]">       
                   - Schedule a consultation with a <Link href={{pathname:`/contact-us`}} legacyBehavior><span className="text-[#46a2da] text-decoration-line: underline">certified financial advisor</span></Link>.
                  </p>  
                  ...
                  <p className="leading-[1.2rem] pb-4 font-normal font-inter text-[#212020] text-[1rem]">       
                  Secure your child’s financial future today. Contact <Link href={{pathname:`/`}} legacyBehavior><span className="text-[#46a2da] text-decoration-line: underline">REKIT Financial Advisors</span></Link>  for expert advice and personalized financial planning. Together, we can turn your dreams for your children into reality.
                  </p>
