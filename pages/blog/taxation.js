...
const Taxation = () => {
  const relatedPosts = blogPosts.filter(p=> p.slug.toLowerCase() == "taxation".toLowerCase());
  ...
  return (
    <div>
      <Head>
        <title>Rekit | REKIT Blog | Taxation</title>
        <meta
          name="description"
        ...
        <title>REKIT Blog | Taxation| Rekit Financial Advisors Limited</title>
        <meta charset="UTF-8" />
        <meta
          name="description"
