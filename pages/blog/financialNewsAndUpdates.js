...
const FinancialNewsAndUpdates = () => {
  const relatedPosts = blogPosts.filter(p=> p.slug.toLowerCase() == "financialNewsAndUpdates".toLowerCase());
  ...
  return (
    <div>
      <Head>
        <title>Rekit | REKIT Blog | Financial News and Updates</title>
        <meta
          name="description"
        ...
        <title>REKIT Blog | Financial News and Updates | Rekit Financial Advisors Limited</title>
        <meta charset="UTF-8" />
        <meta
          name="description"
