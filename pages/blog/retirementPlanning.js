...
const RetirementPlanning = () => {
  const relatedPosts = blogPosts.filter(p=> p.slug.toLowerCase() == "retirementPlanning".toLowerCase());
  ...
  return (
    <div>
      <Head>
        <title>Rekit | REKIT Blog | Retirement Planning</title>
        <meta
          name="description"
        ...
        <title>REKIT Blog | Retirement Planning | Rekit Financial Advisors Limited</title>
        <meta charset="UTF-8" />
        <meta
          name="description"
